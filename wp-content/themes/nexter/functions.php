...
function onioncx_enqueue_scripts()
{
    ...
    wp_enqueue_style('custome-css', get_stylesheet_directory_uri() . '/style.css', null, wp_get_theme()->get('Version'));
...
add_action('wp_enqueue_scripts', 'onioncx_enqueue_scripts');
